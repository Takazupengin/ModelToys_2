...
@SpringBootTest // Levanta el catálogo real conectado a la BD
class MsCatalogoApplicationTests {

	@Autowired
	private ProductRepository productRepository; // repositorio real de productos
	...
	void testVerificarCatalogoDisponible() {
		...
		// Pasa si encuentra los modelos cargados en el sistema
		assertTrue(totalProductos > 0, "Error: El catálogo está vacío en la base de datos real");
	}

	@Test
	void testValidarNombresProductos() {
		// Trae el primer producto que pille en la base de datos de verdad
